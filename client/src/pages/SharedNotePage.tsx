                    ...
                    <CardContent className="pt-6 border-t dark:border-gray-700">
                        ...
                        <div className="flex flex-wrap gap-4 mb-6 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span className="flex items-center gap-1">
                                <Calendar className="h-3.5 w-3.5" /> Created: **{new Date(entry.createdAt).toLocaleTimeString(undefined, DATE_OPTIONS)}**
                            </span>
                            <span className="flex items-center gap-1">
                                <Clock className="h-3.5 w-3.5" /> Updated: **{new Date(entry.updatedAt).toLocaleTimeString(undefined, DATE_OPTIONS)}**
                            </span>
                        </div>
